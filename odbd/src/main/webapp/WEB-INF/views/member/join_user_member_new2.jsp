...
<head>
	...
	<!-- 기본 유효성 검사 -->
	<script src="/js/join_pass.js"></script> 
	<!-- 이메일 셀렉트옵션에 있는 값 넘겨주기 펑션.. ㅅㅂ 이런거까지 펑션까지 만들어서 써야되나-->
		...
		<section>
			...
			<body>
				<div class="member">
                    ...
                    <hr>
                    <div>
                        <input type="submit" class="member" value="다음으로" style="font-size: 18px; font-weight: bold;">
                        <a href="${contextPath}#">
                    </div>
                </div>
		</section>
